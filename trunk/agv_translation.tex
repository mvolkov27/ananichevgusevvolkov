...
\begin{table}[ht]
\extrarowheight=1pt \tabcolsep=4.8pt \caption{Reset threshold of
9-automata with two input letters} \label{automata} {\small
...
\begin{table}[ht]
\extrarowheight=2pt \tabcolsep=3.45pt  \caption{Число достижимых автоматов с 2
