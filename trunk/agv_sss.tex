...
is $n(n-2)+1=(n-1)^2$, is a reset word for $\mathrsfs{C}_n$.
...
automaton $\mathrsfs{W}_n$. Since $w'$ and $v$ act on $Q$ in the same
way, the word $vc$ is a \sw\ for the induced automaton. By Theorem~\ref{theorem:anan}
