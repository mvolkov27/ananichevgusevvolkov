...
and also the maximum known value of reset length for \sa\ without loops. The series
$\mathrsfs{D}''_n$ also enjoys an extremal property: it provides the maximum known
value of reset length for \sa\ in which no letter acts as a permutation.
