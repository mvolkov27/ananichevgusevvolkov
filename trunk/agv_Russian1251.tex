...
поддержку РФФИ по гранту 10-01-793. Третий автор был поддержан также (написать
про поддержку в рамках программы Triple I).}}
...
\bibitem{Be11}
Berlinkov, M.: On a conjecture by Carpi and D'Alessandro. Int.\ J. Foundations
Comp.\ Sci. 22, 1565--1576 (2011)
...
\bibitem{Ka01}
Kari, J.: A counter example to a conjecture concerning synchronizing words in
finite automata. Bull. European Assoc. Theor. Comput. Sci. 73:146, 2001.
...
\bibitem{Sa05}
Sandberg, S.: Homing and synchronizing sequences. In: Broy, M. et~al. (eds.),
Model-Based Testing of Reactive Systems. Lect.\ Notes Comput.\ Sci.,
vol.\,3472, pp.\,5--33. Springer, Berlin-Heidelberg (2005)

\bibitem{ST11}
Skvortsov, E., Tipikin, E.: Experimental study of the shortest reset word of
...
\bibitem{Tr06}
Trahtman, A.N.: An efficient algorithm finds noticeable trends and examples
...
\bibitem{Vo08}
Volkov, M.V.: Synchronizing automata and the \v{C}ern\'{y} conjecture. In:
